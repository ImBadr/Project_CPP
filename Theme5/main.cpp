 ...
 * Parmi les membres de la classe B doit se trouver un objet de la classe A nommé _a.
 * Ecrivez le constructeur de la classe B, trouvez plusieurs manières d'initialiser le membre _a.
 */
    A a2("a2", 20);
    B b1("a1", 10);
    B b2(a2);
